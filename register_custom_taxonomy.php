...
class pbo_register_custom_taxonomy
{
    private $type_name = '';
    ...
    function register_taxonomy()
    {
        $labels = array(
            ...
            'nav_item_name' => 'Novo nome de ' . strtolower($this->singular_name) . '',
            ...
            'view_item' => 'Vizualiza item',
            'remove_item' => 'Adicionar ou remover ' . strtolower($this->singular_name) . '',
            'separate_items_with_commas' => 'Separar por vírgulas',
            'choose_from_must_udes' => 'Escolher entre as mais utilizadas',
            'popular_item' => '' . $this->singular_name . ' mais populares',
            ...
            'items_lits' => 'Lista de ' . strtolower($this->singular_name) . 's',
            'items_list_navegation' => 'Lista de navegação para ' . strtolower($this->singular_name) . 's',
